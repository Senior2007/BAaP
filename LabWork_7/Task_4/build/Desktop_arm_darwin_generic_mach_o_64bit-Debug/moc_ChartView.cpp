...
static constexpr auto qt_meta_stringdata_ZN9ChartViewE = QtMocHelpers::stringData(
    "ChartView"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9ChartViewE[] = {
...
Q_CONSTINIT const QMetaObject ChartView::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9ChartViewE.offsetsAndSizes,
    qt_meta_data_ZN9ChartViewE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9ChartViewE_t,
        // Q_OBJECT / Q_GADGET
...
void *ChartView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9ChartViewE.stringdata0))

...
static constexpr auto qt_meta_stringdata_ZN10TreeWidgetE = QtMocHelpers::stringData(
    "TreeWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10TreeWidgetE[] = {
...
Q_CONSTINIT const QMetaObject TreeWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10TreeWidgetE.offsetsAndSizes,
    qt_meta_data_ZN10TreeWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10TreeWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *TreeWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10TreeWidgetE.stringdata0))

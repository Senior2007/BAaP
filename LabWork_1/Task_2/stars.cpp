...
Stars::Stars(const QPoint& center, int outerRadius, int innerRadius, int numPoints) : Polygon(center, QPoint(-1, -1)), m_outerRadius(outerRadius), m_innerRadius(innerRadius), m_numPoints(numPoints) {
